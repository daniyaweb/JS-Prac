...
// Ques:12 Product Availability Checker
// An online store maintains a list of available products in an array. The store needs a simple system to check whether a specific product is currently available or not.
// Write a program that creates a function to search for a product name in the product list. The function should check each product one by one using a loop and return true if the product is found. If the product does not exist in the list after checking all items, the function should return false. 


var products = ["Phone", "Laptop", "Camera", "HeadPhones", "Keyboard", "Mouse"];
